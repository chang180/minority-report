...
**當前可開工 Gate**：**M2-E**（M2-A～D 已 RELEASED）
...
| M2-E | routes + M2 驗收 | **OPEN** | [M2-E/](briefs/M2-E/) |
...
- 2026-06-13 | M2-B | RELEASED | `app/Consensus/*` Contracts+DTO 骨架、02 §9 簽名對齊；無 SDK 呼叫
- 2026-06-13 | M2-C | RELEASED | `config/consensus.php` + ConsensusServiceProvider + Null stubs DI
- 2026-06-13 | M2-D | RELEASED | audit 三表 migration + VerificationRequest/ProviderResponse/ConsensusResult models
